      ...
      Plugin.prototype.init = function() {
        ...
        $this.data('changeTimerId', -1).css({
          ...
          changeId = setTimeout((function() {
            var i, j, matchText, matchTextList, matches, maxSize, notOverMaxText, overMaxText, spanText, textareaText, words, _i, _j, _len, _len1, _ref, _ref1;
            ...
            return $this.trigger('textarea.highlighter.update', {
